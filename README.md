...
- Experimental tasks (task-augmented `tools/call` + `tasks/*`), with terminal-state and TTL enforcement, blocking result retrieval and handler cancellation; end-to-end lifecycle work remains in progress (#49/#72)
